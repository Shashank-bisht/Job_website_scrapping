...
const scrapeData = async () => {
    ...
    try {
        for (let pageIdx = 1; pageIdx <= 20; pageIdx++) {
            const url = `https://internshala.com/internships/work-from-home-computer-science,django,full-stack-development,reactjs,web-development-internships-in-delhi,gurgaon,noida/page-${pageIdx}/`;
...
const writeToExcel = async (data) => {
  ...
  await workbook.xlsx.writeFile('Internshipwfh.xlsx');
